...
public class AlignToFeederStation extends ProxyCommand {
  ...
  public static Command raiseWhileMoving(Swerve swerve, Arm arm){
    ...
    return swerve.followTrajectoryCommand(traj, false, true)
  ...
  public static Command raiseThenMove(Swerve swerve, Arm arm){
    var startPose = swerve.getPose();
      ...
      return swerve.followTrajectoryCommand(traj1, false, true)
      .andThen(new SetArmPose(arm, ArmPose.FEEDER_STATION))
      .andThen(
        swerve.followTrajectoryCommand(traj2, false, true)
      );
  }
