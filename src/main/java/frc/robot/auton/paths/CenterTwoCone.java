  ...
  public Command getCommand(Subsystems s, String v) {
    ...
    return new SequentialCommandGroup(AutonHelper.setInitRot(s.swerve, "N4_Inert-Start"),
        ...
        AutonHelper.goToGridAlignment(s.swerve, Community.BLUE_GRID.centerGrid.leftCol.high,
            Community.RED_GRID.centerGrid.rightCol.high, Rotation2d.fromDegrees(180), centerTwoConeConstraints),
        ...
        AutonHelper.followWithEvents("N4_Start-Gamepiece1",
            Map.of("stow-arm", new SetArmPose(s.arm, ArmPose.INSIDE_ROBOT), "pickup",
                new FloorPickUp(s.arm, s.wrist).alongWith(AutonHelper.openGrabber(s.grabber))),
