...
public class NoBumpTwoCone extends AutonRoutine {
  ...
  public CommandBase getCommand(Subsystems s, String v) {
      return new SequentialCommandGroup(
        AutonHelper.setInitRot(s.swerve, "N1_Inert-Start"),

        new SetArmPose(s.arm, ArmPose.HIGH_NODE),
        AutonHelper.goToGridAlignment(s.swerve, Community.BLUE_GRID.leftGrid.leftCol.high, Community.RED_GRID.rightGrid.rightCol.high, 
        ...
        AutonHelper.goToGridAlignment(s.swerve, Community.BLUE_GRID.leftGrid.rightCol.high, Community.RED_GRID.rightGrid.leftCol.high, 
          Rotation2d.fromDegrees(180), TwoConeConstraints),
        AutonHelper.getPlaceConeCommand(s)
