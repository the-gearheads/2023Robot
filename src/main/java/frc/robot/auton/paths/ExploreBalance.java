...
public class ExploreBalance extends AutonRoutine {
    ...
    public CommandBase getCommand(Subsystems s, String v) {
      return new SequentialCommandGroup(
        ...
        AutonHelper.followWithEvents("N4_Start-Explore-slow", Map.of("stow-arm", new SetArmPose(s.arm, ArmPose.INSIDE_ROBOT)), false, centerExploreThenDockSlowConstraints,
        s.swerve, false),
