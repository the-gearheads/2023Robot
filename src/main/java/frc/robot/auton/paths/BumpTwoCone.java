...
public class BumpTwoCone extends AutonRoutine {
  ...
  public CommandBase getCommand(Subsystems s, String v) {
      ...
      return new SequentialCommandGroup(
        AutonHelper.setInitRot(s.swerve, "N9_Inert-Start"),

        new SetArmPose(s.arm, ArmPose.HIGH_NODE),
        AutonHelper.goToGridAlignment(s.swerve, Community.BLUE_GRID.rightGrid.rightCol.high, Community.RED_GRID.leftGrid.leftCol.high, 
        ...
        AutonHelper.goToGridAlignment(s.swerve, Community.BLUE_GRID.rightGrid.leftCol.high, Community.RED_GRID.leftGrid.rightCol.high, 
        Rotation2d.fromDegrees(180), TwoConeConstraints),
        AutonHelper.getPlaceConeCommand(s)
