...
public class Constants extends AnnotatedClass {
  ...
  public static final class MECH_PLOT {
    ...
    public static final double[] SIM_WRIST_PID = {100, 0, 10};
  }
  ...
  public static final class DRIVE {
    ...
    public static final double DIRECTION_SLEW_RATE = 4; // radians per second
    public static final double MAG_SLEW_RATE = 8.0; // percent per second (1 = 100%)
    public static final double ROT_SLEW_RATE = 8.0; // percent per second (1 = 100%)
