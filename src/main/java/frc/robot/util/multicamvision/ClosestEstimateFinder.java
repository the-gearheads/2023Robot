...
public class ClosestEstimateFinder {
  ...
  public ClosestEstimateFinder(HashMap<PhotonCamera, Transform3d> camsAndtransforms, AprilTagFieldLayout atfl, SwerveDriveKinematics kinematics) {
    this(
        ()->new Pose2d(), 
        ()->{
  ...
  Supplier<Rotation2d> getRotation, SwerveDriveKinematics kinematics,
  Consumer<Runnable>setResetBuffer ) {
    this(getWheelPose, getModulePositions, getRotation,
    kinematics, setResetBuffer);
    }
