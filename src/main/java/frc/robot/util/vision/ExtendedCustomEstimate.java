...
public class ExtendedCustomEstimate extends CustomEstimate{
    ...
    public ExtendedCustomEstimate(
        Pose3d best, Pose3d alt, double ambiguity, double timestampSeconds, List<PhotonTrackedTarget> targetsUsed, Matrix<N3, N1> confidence) {
    super(best, ambiguity, timestampSeconds, targetsUsed, confidence);
    this.alt=alt;
    }

    public ExtendedCustomEstimate(
    Pose3d best, Pose3d alt, double ambiguity, double timestampSeconds, List<PhotonTrackedTarget> targetsUsed) {
